    ...
    <section className="py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-gradient-to-r from-sky-500 to-indigo-600 rounded-2xl shadow-xl text-white text-center p-8 md:p-12">
          ...
          <Link
            to={token ? '/reserva' : '/login'}
            className="inline-block bg-yellow-400 text-sky-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition transform hover:scale-105"
          >
